...
const sampleData_json_1 = __importDefault(require("../../db/sampleData.json"));
class CurrencyControllers {
    constructor() {
    }
    getAllCurrencyList() {
        return __awaiter(this, void 0, void 0, function* () {
            const CurrencyList = sampleData_json_1.default.map(currencyData => {
...
exports.default = CurrencyControllers;
